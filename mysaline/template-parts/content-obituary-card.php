...
<article <?php post_class( 'ms-card ms-obit-card' ); ?>>
	<div class="ms-card__body" style="align-items:center;text-align:center">
		...
		if ( has_post_thumbnail() ) {
			...
			echo '<img src="data:image/svg+xml;utf8,' . rawurlencode( '<svg xmlns="http://www.w3.org/2000/svg" width="140" height="140"><rect width="140" height="140" fill="#eaf4fc"/><text x="50%" y="52%" font-size="48" fill="#7ba7c0" text-anchor="middle" dominant-baseline="middle" font-family="Georgia">' . esc_html( mb_substr( get_the_title(), 0, 1 ) ) . '</text></svg>' ) . '" width="140" height="140" alt="" />';
		}
		?>
